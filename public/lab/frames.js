...
const COIN_TONES = ['#fff6d6', '#ffe08a', '#f5be3c', '#c6871f', '#7e5212'];
...
window.Frames = { FRAMES, DEFAULT_FRAME, sackArt, COIN_TONES, drawOrnate };
})();
